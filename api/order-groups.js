// /api/order-groups — Estimation order groups (standalone)
//
// GET    /api/order-groups?order_id=uuid          → list groups for an order
// POST   /api/order-groups                        → create group  { order_id, name, sort_order? }
// PATCH  /api/order-groups?id=uuid                → update group  { name?, sort_order? }
// PATCH  /api/order-groups?action=reorder         → bulk reorder  [{ id, sort_order }]
// DELETE /api/order-groups?id=uuid                → delete group
